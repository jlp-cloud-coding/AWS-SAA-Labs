...
## Bootstrapping Logs & Troubleshooting

When EC2 bootstrapping doesn't complete as expected, the **cloud-init** logs provide valuable information for diagnosing failures.

### `/var/log/cloud-init-output.log`

Contains the **stdout and stderr output** generated by the User Data script during instance initialization.

### `/var/log/cloud-init.log`

Contains detailed **cloud-init execution logs**, including the stages of initialization and any errors encountered while processing the User Data.

<img width="959" height="386" alt="Screenshot 2026-07-11 162304" src="https://github.com/user-attachments/assets/7a4f0ae4-0bf8-4f32-a850-5d44e8d83343" />

**Troubleshooting:** These logs are the first place to check if an EC2 instance fails to bootstrap correctly. They help identify issues such as package installation failures, syntax errors in the User Data script, permission problems, or service startup failures.
